...
public class Medicinesandsupplements extends Product{
  ...
  Medicinesandsupplements(String productname, int productid,String producercompany, String description, String expirationdate, double priceofproduct, String typefoodordrink, String nutritionvalue){
...
public void setMedicinesandsupplements(String productname, int productid,String producercompany, String description, String expirationdate, double priceofproduct, String typefoodordrink, String nutritionvalue){
 this.productname=productname;
    this.productid=productid;
    this.description=description;
    this.expirationdate=expirationdate;
